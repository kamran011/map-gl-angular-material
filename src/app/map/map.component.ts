...
import { MapService, MovingOptions } from '../services/map.service';
import { MapEvent } from '../types/map.types';
...
export class MapComponent
  implements
    ...
    MapEvent {
  /* Init inputs */
  @Input() accessToken?: MapboxOptions['accessToken'] = 'pk.eyJ1Ijoia2FtcmFucWF5eXVtOTQiLCJhIjoiY2t5cmRxMjM5MHN5djJxbzVicno0eHhxeiJ9.TIJxDUsyeh7qZTfO5qCeyA';
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    if (
      ...
      if (
        ...
        console.warn(
          '[mapbox-gl] center / zoom / pitch / fitBounds inputs are being overridden by fitScreenCoordinates input'
        );
      }
